...
import paystackInstance from "../config/paystackInstance.js"; // Import Paystack instance
...
const paymentPaystack = async (req, res) => {
    try {
        ...
        const paystackData = {
            ...
            callback_url: `${origin}/verify?appointmentId=${appointmentData._id}`,
        };

        const response = await paystackInstance.initializeTransaction(paystackData);
...
// API to verify payment of appointment using Paystack
